...
@Subselect("SELECT * FROM football_sum_individual_stats") // Hibernate nepoužije @Table, ale použije SQL SELECT
public class FootballSumIndividualStatsEntity {
    ...
    private Integer receivedGoals;

    private Integer ownGoals;

    private Integer goalkeepingMinutes;

    private Integer yellowCards;

    private Integer redCards;

    private Integer bestPlayers;
